...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "android.musicplayer.donate_1";
    private static final String DONATION_2 = "android.musicplayer.donate_2";
    private static final String DONATION_3 = "android.musicplayer.donate_3";
    private static final String DONATION_5 = "android.musicplayer.donate_5";
    private static final String DONATION_10 = "android.musicplayer.donate_10";
    private static final String DONATION_20 = "android.musicplayer.donate_20";
