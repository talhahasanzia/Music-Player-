...
import com.android.musicplayer.dialogs.AddPlaylistDialog;
...
import com.android.musicplayer.widgets.MusicVisualizer;
...
public class BaseQueueAdapter extends RecyclerView.Adapter<BaseQueueAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(localItem.albumId).toString(), itemHolder.albumArt, new DisplayImageOptions.Builder().cacheInMemory(true).showImageOnFail(R.drawable.logo).resetViewBeforeLoading(true).build());
